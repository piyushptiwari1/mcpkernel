...
class MCPGuardError(Exception):
    """Base exception for all mcpguard errors."""
...
class SandboxError(MCPGuardError):
...
class ReplayError(MCPGuardError):
    """Trace replay failed."""
...
def configure_logging(*, json_output: bool = True, level: str = "INFO") -> None:
    """Configure structlog for mcpguard.
