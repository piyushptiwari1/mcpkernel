...
from mcpkernel.utils import AuthError, Timer, get_logger
...
async def _lifespan(app: FastAPI) -> AsyncIterator[None]:
    ...
    from mcpkernel.proxy.hooks import AuditHook, DEEHook, EBPFHook, PolicyHook, TaintHook
    ...
    # Taint tracker
    from mcpkernel.taint import TaintTracker, detect_tainted_sources
...
def create_proxy_app(settings: MCPKernelSettings | None = None) -> FastAPI:
    ...
    async def health() -> dict[str, str]:
        return {"status": "ok", "service": "mcpkernel"}
